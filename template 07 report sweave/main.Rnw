...
\ifthenelse{\boolean{@twoside}}{\myclearpage}{}
%\SweaveInput{A_Introduction}
%\SweaveInput{B_TechnicalBackground}
%\SweaveInput{C_ProblemStatement}
%\SweaveInput{D_Analysis}
%\SweaveInput{E_Results}
%\SweaveInput{F_Conclusion}
